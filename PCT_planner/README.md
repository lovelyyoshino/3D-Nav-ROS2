...
- Ubuntu >= 22.04
- ROS2 Humble (with ros-humble-desktop-full installation)
- CUDA >= 11.7
...
- Start **RViz2** with the provided config: `rviz2 -d rsc/rviz/pct_ros.rviz`
...
- The generated tomogram is visualized as PointCloud2 message in RViz2 and saved in **rsc/tomogram/**.
...
- The generated trajectory is visualized as Path message in RViz2.
