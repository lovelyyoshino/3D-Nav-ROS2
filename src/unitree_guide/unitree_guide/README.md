...
## Environment
We recommand users to run this project in Ubuntu 22.04 and ROS2 Humble environment.
## Dependencies
...
Put these three packages in the src folder of a ROS2 workspace.

## build
Open a terminal and switch the directory to the ROS2 workspace containing unitree_guide, then run the following command to build the project:
```
colcon build
```
...
```
./install/unitree_guide/lib/unitree_guide/junior_ctrl
```
