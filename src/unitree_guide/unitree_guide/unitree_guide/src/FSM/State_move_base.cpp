...
void State_move_base::initRecv(){
    node_ = rclcpp::Node::make_shared("state_move_base");
    _cmdSub = node_->create_subscription<geometry_msgs::msg::Twist>(
        "/cmd_vel", 1, std::bind(&State_move_base::twistCallback, this, std::placeholders::_1));
}
