    ...
    class UnitreeDrawForcePlugin : public VisualPlugin
    {
        ...
        void Load(rendering::VisualPtr _parent, sdf::ElementPtr _sdf )
        {
            ...
            if (!_sdf->HasElement("topicName")){
                RCLCPP_INFO(rclcpp::get_logger("draw_force_plugin"), "Force draw plugin missing <topicName>, defaults to /default_force_draw");
            ...
            this->rosnode = rclcpp::Node::make_shared("gazebo_visual_" + std::to_string(reinterpret_cast<uintptr_t>(this)));
