...
int main(int argc, char **argv)
{
    ...
    auto node = rclcpp::Node::make_shared("example_walk_without_lcm");

    rclcpp::WallRate loop_rate(500);

    long motiontime = 0;

    unitree_legged_msgs::msg::HighCmd high_cmd_ros;

    auto pub = node->create_publisher<unitree_legged_msgs::msg::HighCmd>("high_cmd", 1000);
